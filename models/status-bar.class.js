class StatusBarCharacter  extends DrawableObject { // see World.class.js !!
    IMAGES = [
        './img/7_statusbars/1_statusbar/2_statusbar_health/green/0.png', // 0 = 0% energy
        './img/7_statusbars/1_statusbar/2_statusbar_health/green/20.png',
        './img/7_statusbars/1_statusbar/2_statusbar_health/green/40.png',
        './img/7_statusbars/1_statusbar/2_statusbar_health/green/60.png',
        './img/7_statusbars/1_statusbar/2_statusbar_health/green/80.png',
        './img/7_statusbars/1_statusbar/2_statusbar_health/green/100.png' // 5 = 100% energy
    ];
    ...
    /**
     * Sets the percentage of the health bar for the character.
     * @param {*} percentage 
     */
